...
<div class="page-head">
  <h1>Your servers</h1>
  <p class="muted">Select a server to view stats or edit its configuration.</p>
</div>
...
def ensure_schema():
    """Defensive: create command_settings even if the bot hasn't been
    restarted with the latest main.py yet."""
